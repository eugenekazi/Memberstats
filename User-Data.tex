...
\urlstyle{same}
\hypersetup{
  pdftitle={Club Member Information},
  pdfauthor={Eugene Kazi},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{full\_data}\SpecialCharTok{$}\StringTok{"Account Type"} \OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(full\_data}\SpecialCharTok{$}\StringTok{"Account Type"}\NormalTok{)}
\NormalTok{user\_data }\OtherTok{\textless{}{-}}\NormalTok{ full\_data }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(}\StringTok{"First Name"}\NormalTok{, }\StringTok{"Last Name"}\NormalTok{, }\StringTok{"Email"}\NormalTok{, }\StringTok{"Account Type"}\NormalTok{, }\StringTok{"Signup Date"}\NormalTok{)}
\NormalTok{user\_data}
\end{Highlighting}
\end{Shaded}
